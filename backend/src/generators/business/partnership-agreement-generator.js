...
exports.PartnershipAgreementGenerator = void 0;
const base_document_generator_1 = require("../base/base-document-generator");
class PartnershipAgreementGenerator extends base_document_generator_1.BaseDocumentGenerator {
    ...
    generatePartnershipFormation(input) {
    ...
    generateCapitalContributions(input) {
    ...
    generateProfitLossSharing(input) {
    ...
    generateManagementAndAuthority(input) {
    ...
    generateAdmissionWithdrawal(input) {
    ...
    generateDissolutionProcedures(input) {
...
exports.PartnershipAgreementGenerator = PartnershipAgreementGenerator;
