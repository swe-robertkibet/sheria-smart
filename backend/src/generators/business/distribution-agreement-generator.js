...
exports.DistributionAgreementGenerator = void 0;
const base_document_generator_1 = require("../base/base-document-generator");
class DistributionAgreementGenerator extends base_document_generator_1.BaseDocumentGenerator {
    ...
    generatePartiesAndDefinitions(input) {
    ...
    generateDistributionRights(input) {
    ...
    generateTerritoryAndExclusivity(input) {
    ...
    generateDistributorObligations(input) {
    ...
    generatePrincipalObligations(input) {
    ...
    generatePricingAndPayment(input) {
    ...
    generateMarketingAndPromotion(input) {
    ...
    generatePostTerminationObligations(input) {
...
exports.DistributionAgreementGenerator = DistributionAgreementGenerator;
