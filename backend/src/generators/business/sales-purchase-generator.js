...
exports.SalesPurchaseGenerator = void 0;
const base_document_generator_1 = require("../base/base-document-generator");
class SalesPurchaseGenerator extends base_document_generator_1.BaseDocumentGenerator {
    ...
    generatePartiesIdentification(input) {
    ...
    generateDisputeResolution(input) {
...
exports.SalesPurchaseGenerator = SalesPurchaseGenerator;
